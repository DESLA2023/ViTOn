...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=bool, default="./result_demo/origin.jpg", help='Define input(.jpg) path dir # default=\"./result_demo/origin.jpg\"')
    ...
    input_image, draw_image, output_scale = posenet.read_imgfile(input_path, scale_factor=scale_factor, output_stride=output_stride)
    #print(input_image)
    with torch.no_grad():
    ...
    pose_name = '{}/openpose_json/00001_00_keypoints.json'.format(output_dir) 
